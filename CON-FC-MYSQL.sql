...
GROUP BY NOMBRE_CONTINENTE;
-- punto 13
-- obtener el numero de paises registrados por continente.
SELECT NOMBRE_CONTINENTE AS CONTINENTE, COUNT(ID_PAIS) AS 'NO. PAISES'
FROM PAISES P RIGHT JOIN CONTINENTES CO
    ON CO.ID_CONTINENTE = P.CONTINENTES_ID_CONTINENTE
GROUP BY NOMBRE_CONTINENTE;
